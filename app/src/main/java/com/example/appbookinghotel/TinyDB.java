...
public class TinyDB {
    ...
    public ArrayList<HotelDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<HotelDomain> playerList =  new ArrayList<HotelDomain>();

        for(String jObjString : objStrings){
            HotelDomain player  = gson.fromJson(jObjString,  HotelDomain.class);
    ...
    public void putListObject(String key, ArrayList<HotelDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(HotelDomain player: playerList){
