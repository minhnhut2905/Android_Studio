...
public class ListHotel_Activity extends AppCompatActivity {
    private RecyclerView.Adapter hotelListAdapter;
    private RecyclerView rcv_Hotel;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.listhotel_activity);
            ...
            public void onNavigationItemReselected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.action_home:
                        startActivity(new Intent(ListHotel_Activity.this,Home_Activity.class));
                        break;
                    case R.id.action_dondatcho:
                        startActivity(new Intent(ListHotel_Activity.this, DonDatPhongActivity.class));
                }
            }
        });
        initRecyclerView();
